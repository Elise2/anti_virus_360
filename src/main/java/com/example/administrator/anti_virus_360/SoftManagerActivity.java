...
import adapter.SoftManagerAdapter;
 ...
 */
public class SoftManagerActivity extends ActionBarActivity implements ManagerService.OnScanTaskListener {
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            //绑定成功执行任务
            managerService.setListener(SoftManagerActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.anti_virus_clear_morespeed2);
...
//        actionBar.setTitle("骚扰拦截");
        ...
        speedNum = (TextView) findViewById(R.id.speedNum2);
        memoryInfo = (TextView) findViewById(R.id.memoryInfo2);
        ...
        ps = new ArrayList<>();
        adapter = new SoftManagerAdapter(list, this);

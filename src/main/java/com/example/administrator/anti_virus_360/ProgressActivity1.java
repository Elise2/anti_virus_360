 ...
 */
public class ProgressActivity1 extends ActionBarActivity implements ManagerService.OnScanTaskListener,
    ...
    private ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            //绑定成功执行任务
            managerService.setListener(ProgressActivity1.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.anti_virus_clear_morespeed1);
...
//        actionBar.setTitle("骚扰拦截");
        ...
        speedNum =(TextView)findViewById(R.id.speedNum1);
        ...
        public void onClick(View view) {
            ...
            Toast.makeText(ProgressActivity1.this,
